...
def mobilenetv2_x1_0(
    ...
    num_classes=751, 
    pretrained=True, 
    pretrained_dataset='market1501',
    **kwargs):

    if pretrained_dataset == 'market1501':
        num_classes = 1501
        ckpt_path = './pretrained_models/tracker/mobilenetv2_1.0_market1501.pth.tar'
        ...
        ckpt_path = './pretrained_models/tracker/mobilenetv2_1dot0_msmt.pth.tar'
    ...
    if pretrained:
        init_pretrained_local(model,ckpt_path)
       
    return model


def mobilenetv2_x1_4(
    loss='softmax', 
    num_classes=751, 
    pretrained=True, 
    pretrained_dataset='market1501',
    **kwargs):
    ...
    if pretrained_dataset == 'market1501':
        num_classes = 1501
        ckpt_path = './pretrained_models/tracker/mobilenetv2_1dot4_market.pth.tar'

    elif pretrained_dataset == 'duke':
        num_classes = 702
        ckpt_path = './pretrained_models/tracker/mobilenetv2_1dot4_duke.pth.tar'

    elif pretrained_dataset == 'msmt17':
        ckpt_path = './pretrained_models/tracker/mobilenetv2_1dot4_msmt.pth.tar'
